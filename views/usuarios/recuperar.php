...
<div class="usuarios-recuperar">
    ...
    <div class="container bg-white w-sm w-lg w-xl rounded shadow-sm">
        ...
        <div class="forms m-2 p-3" style="height: 350px;">
            ...
            <?= $form->field($model, 'correo')->textInput(['placeholder' => 'Ingrese su correo', 'value' => '', 'class' => 'inputs col-12'])->label(false) ?>
            
            <p>Por favor, ingrese su correo para poder verificar que usted tiene cuenta.</p>
            <hr>
            <div class="form-group">
                <div class="offset-sm-2">
                    <?= Html::submitButton('Enviar', ['class' => 'btn btn-orange col-12 mx-auto', 'data-toggle' => 'modal', 'data-target' => '#loading', 'name' => 'login-button']) ?>
                </div>
            </div>
